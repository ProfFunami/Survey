...
\title{Interpreting Graph Neural Networks for NLP With Differentiable Edge Masking\ \cite{schlichtkrull2020interpreting}}
...
\begin{document}
    ...
    \section{どういう論文？}
    \cite{li2022explainability}: 「\cite{ying2019gnnexplainer}のマスキングの考え方に沿って、
    GraphMaskが、重要なエッジを予測するスタンドアローンモデルの学習を提案し、
    多層パーセプトロンに基づいている」
