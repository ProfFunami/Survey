...
\title{On Explainability of Graph Neural Networks via Subgraph Explorations\ \cite{yuan2021explainability}}
\author{Hao Yuan, Haiyang Yu, Jie Wang, Kang Li, Shuiwang Ji}
\date{2021}
% Document
\begin{document}
    \maketitle
    ...
    \section{どういう論文？}
    \cite{li2022explainability}: 「SubgraphXは重要なサブグラフを特定するためにMonte Carlo Tree Searchを採用」
